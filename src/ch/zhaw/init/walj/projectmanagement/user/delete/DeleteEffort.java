...
public class DeleteEffort extends HttpServlet {
     ...
     *	deletes the effort and shows success/error message to the user
     */
	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// get user, project and effort ID
		...
		if (project.getLeader() == userID){
			...
			try {
				...
				message = "<div class=\"row\">"
						...
						+ "<a href=\"/Projects/Edit?projectID=" + projectID + "#effort\">Click here to go back to the edit page</a>"
						+ "<br>"
			...
			// Print HTML
			out.println(HTMLHeader.getInstance().printHeader("Delete Effort", "../", "Delete Effort", "")
					  + "<section>"
					  + message
					  + "</section>"
