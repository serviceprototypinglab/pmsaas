...
public class EffortOverview extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (project.getLeader() == id){
			...
			// print header
			out.println(HTMLHeader.getInstance().printHeader(project.getShortname(), "../../", "Effort", "", link, false)
					  + "<section>"
					  + "<div class=\"row\">"
			...
			if (employeeID == 0){
				...
				employees.add(project.getEmployee(employeeID));
			...
			out.println("<tr class=\"bold\">"
					  ...
					  + "<a class=\"button expanded\" href=\"/Projects/Overview/bookHours?projectID=" + project.getID() + "\">"
