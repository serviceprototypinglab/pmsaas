		...
		if (project.getLeader() == userID) {
			...
			try {
				...
				message = "<div class=\"callout success\">"
						...
						+ "<a href=\"/Projects/Edit?projectID=" + projectID + "#workpackages\">Click here to go back to the edit page</a>"
						+ "<br>"
				...
				message = "<div class=\"callout alert\">"
						...
						+ "<a href=\"/Projects/Edit?projectID=" + projectID + "\">Click here to go back to the edit page</a>"
						+ "<br>"
						+ "<a href=\"/Projects/Overview/Project?id=" + projectID + "\">Click here to go to the project overview</a>"
						+ "</div>";
			}
