...
package ch.zhaw.init.walj.projectmanagement.user.edit;
		...
		if (project.getLeader() == userID) {
			...
			try {
				...
				message = "<div class=\"callout success\">"
						...
						+ "<p>Budget: " + budget + "</p>"
						+ "<p>Workpackage: " + wp + "</p>"
						+ "<a href=\"/Projects/Edit?projectID=" + projectID + "#tasks\">Click here to go back to the edit page</a>"
						+ "<br>"
						+ "<a href=\"/Projects/Overview/Project?id=" + projectID + "\">Click here to go to the project overview</a>"
						+ "</div>";
			} catch (SQLException e) {
				...
				message = "<div class=\"callout alert\">"
						...
						+ "<a href=\"/Projects/Edit?projectID=" + taskID + "#tasks\">Click here to go back to the edit page</a>"
						+ "<br>"
						+ "<a href=\"/Projects/Overview/Project?id=" + taskID + "\">Click here to go to the project overview</a>"
						+ "</div>";
			}
